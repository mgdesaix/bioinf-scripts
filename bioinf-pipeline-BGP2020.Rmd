---
title: "Bioinformatics Workflow: BGP 2020"
output: html_notebook
---


This details the general initial steps I've been using to process the raw whole-genome sequence files for ROFI and AMRE.  
...
I've been using the program FastUniq to do this, see the _1.trim.sbatch_ file for the full code.  But an example is as follows:
...
Then, I run through the _2.map.sbatch_ script.
